# rng
    ...
    scoreboard players set $rng_max bbl.rng 14
    function bb:lib/rng
# playsound
    execute if score $value bbl.rng matches 1..11 run playsound entity.player.levelup master @s ~ ~ ~ 0.4 1.5
    execute if score $value bbl.rng matches 12..14 run playsound item.firecharge.use master @s ~ ~ ~ 0.6 0.7
# effect
    # good
        execute if score $value bbl.rng matches 1 run effect give @s absorption 60 2
        ...
        execute if score $value bbl.rng matches 4 run effect give @s health_boost 60 2
    ...
    # bad
        execute if score $value bbl.rng matches 12 run effect give @s mining_fatigue 30 1
        execute if score $value bbl.rng matches 13 run effect give @s slowness 30 2
        execute if score $value bbl.rng matches 14 run effect give @s weakness 30 2
