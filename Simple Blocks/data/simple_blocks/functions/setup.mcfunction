...
scoreboard objectives add simple_blocks.opened.blast_furnace custom:interact_with_blast_furnace
scoreboard objectives add simple_blocks.opened.furnace custom:interact_with_furnace
